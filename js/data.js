...
export const SCENES = [
  {
    ...
    delayBeforeText: DEFAULT_TEXT_DELAY,
    mapZoom: 17,
...
export function buildSceneState(scene, sceneEdit = {}) {
  const quote =
    typeof sceneEdit.quote === "string" && sceneEdit.quote.trim()
      ? sceneEdit.quote.trim()
      : scene.quote;

  const interpretation =
    typeof sceneEdit.interpretation === "string" && sceneEdit.interpretation.trim()
      ? sceneEdit.interpretation.trim()
